...
###############CO Regression################
CO_traffic <- lm(CO_value ~ ., data = Traffic_CO)
summary(CO_traffic)
...
CO_traffic1 <- lm(CO_value ~ Year + Traffic_Test + LGA, data = Traffic_CO)
summary(CO_traffic1)
...
CO_traffic2 <- lm(CO_value ~ Year*Traffic_Test + Year*LGA, data = Traffic_CO)
summary(CO_traffic2)
...
CO_traffic4 <- lm(log(CO_value) ~ Traffic_Test + Year*LGA, data = Traffic_CO)
summary(CO_traffic4)
summary(CO_traffic4)$sigma # RSE
summary(CO_traffic4)$r.squared # R ^ 2
summary(CO_traffic4)$coefficients 
par(mfrow = c(2, 2))
plot(CO_traffic4)

Traffic_CO <- Traffic_CO[-19,]

CO_traffic5 <- lm(log(CO_value) ~ Traffic_Test + Year*LGA, data = Traffic_CO)
summary(CO_traffic5)
summary(CO_traffic5)$sigma # RSE
summary(CO_traffic5)$r.squared # R ^ 2
summary(CO_traffic5)$coefficients 
par(mfrow = c(2, 2))
plot(CO_traffic5)
...
##################################### NO Regression################
NO_traffic <- lm(NO_value ~ ., data = Traffic_NO)
summary(NO_traffic)
summary(NO_traffic)$sigma # RSE
summary(NO_traffic)$r.squared # R ^ 2
summary(NO_traffic)$coefficients
par(mfrow = c(2, 2))
plot(NO_traffic)
...
summary(NO_traffic1)$coefficients
par(mfrow = c(2, 2))
plot(NO_traffic1)

bptest(NO_traffic2)

NO_traffic2 <- lm(log(NO_value) ~ LGA*Year, data = Traffic_NO)
summary(NO_traffic2)
...
summary(NO2_traffic)
summary(NO2_traffic)$sigma # RSE
summary(NO2_traffic)$r.squared # R ^ 2
summary(NO2_traffic)$coefficients
par(mfrow = c(2, 2))
plot(NO2_traffic)

NO2_traffic1 <- lm(NO2_value ~ LGA + Traffic_Test - Year, data = Traffic_NO2)
summary(NO2_traffic1)
summary(NO2_traffic1)$sigma # RSE
summary(NO2_traffic1)$r.squared # R ^ 2
summary(NO2_traffic1)$coefficients
par(mfrow = c(2, 2)) 
plot(NO2_traffic1)

Traffic_NO2 <- Traffic_NO2[-c(118,119),]

NO2_traffic2 <- lm(NO2_value ~ LGA + Traffic_Test - Year, data = Traffic_NO2)
summary(NO2_traffic2)
summary(NO2_traffic2)$sigma # RSE
summary(NO2_traffic2)$r.squared # R ^ 2
summary(NO2_traffic2)$coefficients
par(mfrow = c(2, 2))
plot(NO2_traffic2)
